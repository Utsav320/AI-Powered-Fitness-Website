...
let arrow=document.querySelector(".select-heading img") // accessing the toogle, rotate walii
let options=document.querySelector(".options")
let option=document.querySelectorAll(".option")
let selecttext=document.querySelector(".select-heading span")

select.addEventListener("click",()=>{
options.classList.toggle("active-options") // All workout pe click krne k badd sare list of workout show lgne lge
arrow.classList.toggle("rotate")
})

option.forEach((item)=>{   // sare option ek bar me aa jaaenge, items will works like as options
